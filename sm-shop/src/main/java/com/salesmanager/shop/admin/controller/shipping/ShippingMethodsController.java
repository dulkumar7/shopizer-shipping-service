...
import com.salesmanager.shop.restclients.ShippingServiceClient;
...
//		List<IntegrationModule> modules = shippingService.getShippingMethods(store);
		List<IntegrationModule> modules = shippingServiceClient.getShippingMethods(store);
...
//		Map<String,IntegrationConfiguration> configuredModules = shippingService.getShippingModulesConfigured(store);
		...
		Map<String,IntegrationConfiguration> configuredModules = shippingServiceClient.getShippingModulesConfigured(store);
...
//		IntegrationConfiguration configuration = shippingService.getShippingConfiguration(code, store);
		IntegrationConfiguration configuration = shippingServiceClient.getShippingConfiguration(code, store);
